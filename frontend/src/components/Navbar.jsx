      ...
      <div className="flex container mx-auto justify-between items-center">
        ...
        {user ? (
          <div className="flex gap-2">
            <Link
              to={"/dashboard"}
              className="bg-black px-6 py-2 rounded-full text-white hover:bg-orange-500 "
            >
              Dashboard
            </Link>
            <button
              onClick={logoutUser}
              className="bg-orange-500 text-white px-6 py-2 rounded-full cursor-pointer hover:bg-black  duration-300 "
            >
              Logout
            </button>
          </div>
